...
LEADERS_CATEGORY = (
    ...
    ('Opensource Lead','Opensource Lead'),
    ('Future comm lead','Future comm lead'),
    ('WebDevOps Lead','WebDevOps Lead'),
)
...
class Leader(models.Model):
    title = models.CharField(choices=TITLE, blank=True, max_length=100)
...
class  Community(models.Model):
    ...
    image = models.ImageField(upload_to='comunity_images/', default='community_images/default.jpg')
    image_thumbnail = ImageSpecField(source='image',
